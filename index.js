...
export default {
     ...
     */
    setup: function (configKey: string, flushAt: number = 20, shouldTrackApplicationLifecycleEvents: bool = false) {
        NativeRNSegmentIOAnalytics.setup(configKey, flushAt, shouldTrackApplicationLifecycleEvents)
    },
